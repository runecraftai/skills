...
description: >
  Hardens code against vulnerabilities using the OWASP Top 10 and a three-tier boundary system
  (input, processing, output). Use when handling user input, authentication, data storage,
  or external integrations.
  EN triggers: /security, security audit, OWASP, three-tier boundary, least privilege, input validation.
